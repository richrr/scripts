...
public class CountGC {
	...
	public static void main(String[] args){
		...
		if(benchmark){
			...
			System.err.println(String.format(Locale.ROOT, "Raw Speed:         \t%.2f MBytes/s",mbps1));
			System.err.println(String.format(Locale.ROOT, "Uncompressed Speed:\t%.2f MBytes/s",mbps2));
		}else{
			...
			System.err.println(String.format(Locale.ROOT, "Speed:\t%.2f MBytes/s",mbps));
			System.err.println(String.format(Locale.ROOT, "      \t%.2f MBases/s",mbpps));
		}
