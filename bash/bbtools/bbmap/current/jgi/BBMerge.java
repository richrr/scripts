...
//			System.err.println("Loaded "+kmers+" kmers in "+tload);
		...
		if(parseCustom){
			System.err.println();
			System.err.println("Correct:             \t"+correctCountTotal+String.format((correctCountTotal<10000 ? "       " : "   ")+"\t%.4f%%", correctCountTotal*divp)+String.format(Locale.ROOT, "  \t%.4f%% of merged", correctCountTotal*div2));
			System.err.println("Incorrect:           \t"+incorrectCountTotal+String.format((incorrectCountTotal<10000 ? "       " : "   ")+"\t%.5f%%", incorrectCountTotal*divp)+String.format(Locale.ROOT, " \t%.5f%% of merged", incorrectCountTotal*div2));
			...
			System.err.println("SNR:                 \t"+String.format(Locale.ROOT, "%.3f dB", snrDB));
			System.err.println();
			System.err.println("Avg Insert Correct:  \t"+String.format(Locale.ROOT, "%.1f", (insertSumCorrectTotal)*1d/(correctCountTotal)));
			System.err.println("Avg Insert Incorrect:\t"+String.format(Locale.ROOT, "%.1f", (insertSumIncorrectTotal)*1d/(incorrectCountTotal)));
		}
		...
		System.err.println("Standard Deviation:  \t"+String.format(Locale.ROOT, "%.1f", stdev));
