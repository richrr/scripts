...
//			list.add("k=13");
	...
	void printSettings(int k){
		...
		if(verbose_stats>=2){
			...
			sysout.println("Fraction To Remove:    \t"+String.format(Locale.ROOT, "%.4f", (BBIndexPacBio.REMOVE_FREQUENT_GENOME_FRACTION ? BBIndexPacBio.FRACTION_GENOME_TO_EXCLUDE : 0)));
