...
#usage: python ~/scripts/python/stitch_pe_reads_pandaseq.py -o ../pandaseq_stitched/
# the following was run in Trimmed_fastq_files
# python ~/scripts/python/stitch_pe_reads_pandaseq.py -i ../../../../../../SampleSheet_w_groups.csv -q -o ../pandaseq_stitched/ -d ,
# the following was run in Trimmed_fastq_files/q25
# python ~/scripts/python/stitch_pe_reads_pandaseq.py -i ../../../../../../../SampleSheet_w_groups.csv -q -o ../../pandaseq_stitched/q25 -d ,
