...
#python ~/scripts/python/plot-network-graph.py -i L3_invasive\ 0.310\ edge_attribute-randomwalk.txt -n L3_invasive\ 0.310\ node_attribute-randomwalk.txt -a L3_invasive.txt
...
def main(args):
    ...
    if args.edgetypeoff:
        ...
        draw_plots_with_edge_attributes(infile, node_attrib_file, outfilestring, img_qual, img_frmt, delim, attrib_color_map, categ_color_map, edge_color_map, node_abund_file)
