...
if(argv$runfreqmerge)
{
	...
	freqcmd= paste("Rscript merge-calc-freq-result-files.R", "--files", freqinfile, "--parallel --output", argv$output, "--transposeOutput", "--pvalThreshold", argv$pvalThreshold, "--combPvalCutoff", argv$combPvalCutoff, "--combFDRCutoff", argv$combFDRCutoff, sep=" ")
