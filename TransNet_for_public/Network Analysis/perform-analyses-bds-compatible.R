...
source("comp-correl-delta-paired-util-functs.R")
...
freqcmd= paste("Rscript calc-frequency-bds-compatible.R", argv$expressionDataFile, "--lists", list1File, list1File, "--mapFile", argv$mapFile, "--mapColumns", samplIdCol, exptCol, "--AnalysToDoList", argv$AnalysToDoList, "--comparMethod",  argv$comparMethod, "--correlMethod", argv$correlMethod, "--symbolColumnName", symbleColumnName, "--pairedInfoColumn", argv$pairedInfoColumn, "--output", freqdir, sep=" ")
